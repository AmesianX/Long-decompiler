...
///
/// The \b topological \b scope of a variable within a function is the std::set of
...
///
/// Internally this is implemented as a std::map from basic block to their non-empty CoverBlock
class Cover {
